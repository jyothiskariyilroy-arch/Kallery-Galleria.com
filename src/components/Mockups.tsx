...
// 3-column grid: each card is ~33vw desktop, 50vw tablet, 100vw mobile
const MOCKUP_SIZES =
  ...
  return (
    <section ref={ref} id="mockups" className="relative py-32 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {images.mockups.map((src, i) => (
            ...
            >
              <MockupImage
                src={src}
                alt={mockupLabels[i]?.title ?? `AI mockup ${i + 1}`}
              />
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5">
                ...
                <p className="font-mono text-[0.52rem] uppercase tracking-widest text-gold/55 mt-1">
                  {mockupLabels[i]?.sub}
                </p>
              </div>
        ...
        >
          <p className="text-ivory/20 font-dm text-sm mb-6">
            Every floor is ready for immediate commercial operation — adaptable to your business.
          </p>
