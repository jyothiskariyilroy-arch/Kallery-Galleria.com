    ...
    <div className={`relative overflow-hidden rounded-xl bg-obsidian-800 group ${className}`}>
      ...
      {error ? (
        ...
        <Image src={src} alt={alt} fill
          ...
          unoptimized onLoad={() => setLoaded(true)} onError={() => setError(true)} />
      )}
...
const captions = [
  "Main road frontage", "Ground floor — 4,000 sq ft",
  "Open floor plate", "Natural light advantage",
];
    ...
    <section ref={ref} id="gallery" className="relative py-32 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-12">
        <div className="mb-14 flex flex-col lg:flex-row lg:items-end justify-between gap-6">
          <div>
            <motion.p className="label mb-5" initial={{ opacity: 0 }} animate={inView ? { opacity: 1 } : {}}>
              Gallery
            </motion.p>
        ...
        <motion.div className="grid grid-cols-12 grid-rows-3 gap-3 h-[680px]"
        ...
        <motion.div className="mt-5 grid grid-cols-2 lg:grid-cols-4 gap-3"
