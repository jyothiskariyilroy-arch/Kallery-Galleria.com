        ...
        <Image
          ...
          sizes={
            isLarge
              ...
              : "(max-width: 768px) 50vw, (max-width: 1200px) 30vw, 350px"
          }
              ...
              >
                <div className="grid lg:grid-cols-2 gap-8 items-start">
                  ...
                  <div className="lg:pl-4">
                    ...
                    <h3 className="font-cormorant text-4xl md:text-5xl font-light text-ivory mb-2">
                      {floor.label}
                    </h3>
                    ...
                    <div className="space-y-3 mb-8">
                      {[
                        ...
                        <div
                          key={spec.label}
                          className="flex items-start gap-4 py-2 border-b border-white/[0.04]"
                        >
