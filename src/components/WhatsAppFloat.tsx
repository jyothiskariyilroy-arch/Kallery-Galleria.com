...
export default function WhatsAppFloat() {
  ...
  return (
    <motion.div className="fixed bottom-8 right-8 z-50 flex items-center gap-3"
      ...
      <a href={href} target="_blank" rel="noopener noreferrer"
        ...
        style={{ background: "linear-gradient(135deg, #25D366, #128C7E)",
          boxShadow: hovered ? "0 8px 30px rgba(37,211,102,0.5)" : "0 4px 20px rgba(37,211,102,0.3)" }}
